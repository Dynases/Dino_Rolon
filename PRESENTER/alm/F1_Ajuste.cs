...
using UTILITY.MetodosExtension;
    ...
    public partial class F1_Ajuste : MODEL.ModeloF1
    {
        ...
        private void MP_ArmarGrillaListado()
        {
            try
            {
                ...
                Dgv_GBuscador.ColAL(nameof(EntList.NCategoriaPrecio), "Categoria precio", 150);
        ...
        public void MP_ArmarGrillaDetalle()
        {
            try
            {
                ...
                dgjDetalle.ColIcon("Eliminar", string.Empty, new Bitmap(Properties.Resources.minus, new Size(15, 15)));
        ...
        private void MP_Limpiar()
        {
            try
            {
                ...
                _ajuste.IdCategoriaPrecio = categoriaPrecio.First().Id;
        ...
        private void MP_MostrarRegistro(int _Pos)
        {
            try
            {
                ...
                if(_Pos > -1)
                {
                    ...
                    _ajuste.IdCategoriaPrecio = categoriaPrecio.First(a => a.Descrip == ajuste.NCategoriaPrecio).Id;
